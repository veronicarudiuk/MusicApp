...
class TutorialScreensVC: UIViewController {
    ...
    enum Constants {
        ...
        static let firstText: String = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore."
