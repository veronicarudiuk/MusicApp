...
class ProfileVC: UIViewController {
    ...
    var userName: UILabel = {
        let label = UILabel()
        label.text = "Name: Vladislav Radchikov"
        label.textColor = .white
        label.textAlignment = .center
        label.numberOfLines = 0
    ...
    var userEmail: UILabel = {
        let label = UILabel()
        label.text = "Email: zcredi@gmail.com"
        label.textColor = .white
        label.textAlignment = .center
        label.numberOfLines = 0
        label.font = UIFont(name: K.Fonts.interRegular, size: 14)
    ...
    private func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            userName.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -188),
            ...
            userEmail.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -200),
